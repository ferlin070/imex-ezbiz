...
values
  ('c1111111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'A', 'Persembahan', 65, 1.5, 1),
  ('c2222222-2222-2222-2222-222222222222', 'e1111111-1111-1111-1111-111111111111', 'B', 'Semangat Berpasukan', 40, 1.0, 2),
  ('c3333333-3333-3333-3333-333333333333', 'e1111111-1111-1111-1111-111111111111', 'C', 'Idea Boleh Dipasarkan', 65, 2.0, 3)
on conflict (id) do nothing;

-- ========== SEED PROJECTS ==========
insert into projects (id, event_id, title, description, category, team_members, owner_user_id)
values
  ('p1111111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'F.O.C.U.S DRIVE', 'Sistem pemanduan pintar berasaskan IoT untuk mengurangkan kemalangan jalan raya akibat keletihan pemandu dengan memantau pergerakan mata dan memberikan amaran masa nyata.', 'Automotif & IoT', array['Ahmad', 'Ali', 'Abu'], 'b1111111-1111-1111-1111-111111111111'),
  ('p2222222-2222-2222-2222-222222222222', 'e1111111-1111-1111-1111-111111111111', 'FOOD DRYER', 'Mesin pengering makanan berasaskan tenaga solar hibrid dengan kawalan suhu automatik untuk kegunaan usahawan mikro desa memproses hasil tani dengan lebih cepat.', 'Teknologi Makanan', array['Siti', 'Sarah'], 'b2222222-2222-2222-2222-222222222222'),
  ('p3333333-3333-3333-3333-333333333333', 'e1111111-1111-1111-1111-111111111111', 'Smart Grass Chopper', 'Alat pemotong rumput pintar yang dikawal melalui aplikasi telefon pintar dengan sensor pengesanan halangan untuk keselamatan dan kecekapan penyelenggaraan landskap.', 'Mekanikal & Robotik', array['Chong', 'Muthu'], null),
  ('p4444444-4444-4444-4444-444444444444', 'e1111111-1111-1111-1111-111111111111', 'Mobile Poison Sprayer', 'Mesin penyembur racun tanaman mudah alih berautonomi menggunakan roda berkuasa tinggi untuk aplikasi sektor pertanian pintar berskala kecil.', 'Pertanian Pintar', array['Wan', 'Zaki'], null)
on conflict (id) do nothing;

-- ========== SEED JUDGES ==========
insert into judges (id, event_id, user_id, panel_label, name)
values
  ('j1111111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'Panel 1', 'Encik Khairul'),
  ('j2222222-2222-2222-2222-222222222222', 'e1111111-1111-1111-1111-111111111111', 'a2222222-2222-2222-2222-222222222222', 'Panel 2', 'Puan Zaimah'),
  ('j3333333-3333-3333-3333-333333333333', 'e1111111-1111-1111-1111-111111111111', 'a3333333-3333-3333-3333-333333333333', 'Panel 3', 'Dr. Firdaus')
on conflict (id) do nothing;

-- ========== SEED SCORES (MOCK DATA FOR F.O.C.U.S DRIVE) ==========
-- FOCUS Drive scored high by all panels to make it "Sangat Berpotensi" (80%+)
insert into scores (project_id, judge_id, criteria_id, score)
values
  -- Judge 1 (Encik Khairul)
  ('p1111111-1111-1111-1111-111111111111', 'j1111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 58), -- Presentation (58/65)
  ('p1111111-1111-1111-1111-111111111111', 'j1111111-1111-1111-1111-111111111111', 'c2222222-2222-2222-2222-222222222222', 32), -- Teamwork (32/40)
  ('p1111111-1111-1111-1111-111111111111', 'j1111111-1111-1111-1111-111111111111', 'c3333333-3333-3333-3333-333333333333', 55), -- Marketability (55/65)

  -- Judge 2 (Puan Zaimah)
  ('p1111111-1111-1111-1111-111111111111', 'j2222222-2222-2222-2222-222222222222', 'c1111111-1111-1111-1111-111111111111', 60),
  ('p1111111-1111-1111-1111-111111111111', 'j2222222-2222-2222-2222-222222222222', 'c2222222-2222-2222-2222-222222222222', 35),
  ('p1111111-1111-1111-1111-111111111111', 'j2222222-2222-2222-2222-222222222222', 'c3333333-3333-3333-3333-333333333333', 58),

  -- Judge 3 (Dr. Firdaus)
  ('p1111111-1111-1111-1111-111111111111', 'j3333333-3333-3333-3333-333333333333', 'c1111111-1111-1111-1111-111111111111', 55),
  ('p1111111-1111-1111-1111-111111111111', 'j3333333-3333-3333-3333-333333333333', 'c2222222-2222-2222-2222-222222222222', 30),
  ('p1111111-1111-1111-1111-111111111111', 'j3333333-3333-3333-3333-333333333333', 'c3333333-3333-3333-3333-333333333333', 52)
on conflict (id) do nothing;
